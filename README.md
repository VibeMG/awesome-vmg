...
- [完整 VMG 工程](projects/README.md)：标准工程的交付与使用方式；首版尚未发布工程。
...
工程索引和目录已经预留，后续填入真实源码工程即可，无需改造 CLI。外部链接、视频预览和 `.vmgc` 编译预览不冒充完整源码工程。

## 来源与许可

本库自己编写的说明、索引与脚本采用 [Apache-2.0](LICENSE)。外部作品、源码、媒体、品牌与商标仍遵循各自的授权；链接公开可见不意味着素材可以随库再分发。

首版保存外部链接与借鉴说明，没有下载或打包第三方影片、AE 工程或图库素材。各条目的查看记录区分画面、预览、介绍页和检索线索，保留实际观察范围。
